    ...
    public sealed class AccountController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] LoginModel login)
        {
            try
            {
                ...
                login.RoleId = (int)RoleEnum.User;
        ...
        //        model.UserName = model.MobileNo;
        //        model.Password = _appUtility.CreateRandomPassword(6);
        //        var user = _accountService.Registration(model);
        //        if (user != null)
        //        {
        //            if (user.IsSucess == 1)
        //            {
        ...
        //            {
        //                return Ok(new { Type = "success", Code = HttpStatusCode.OK.ToString(), Message = MessageStream.MobileNoAlreadyExist, Data = user });
        //            }
        //            else
        //                return Ok(new { Type = "success", Code = HttpStatusCode.OK.ToString(), Message = MessageStream.SomethingWentWrong });

        //        }
        //        else
        //        {
        //            return Ok(new { Type = "success", Code = HttpStatusCode.BadRequest.ToString(), Message = MessageStream.SomethingWentWrong });
        //        }
        //    }
        //    catch (Exception ex) { return Ok(new { Type = "fail", Code = HttpStatusCode.BadRequest.ToString(), Message = ex.Message }); }
